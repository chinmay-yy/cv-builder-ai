  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <a href="https://youtu.be" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
        ...
        <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            ...
            <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
                <a href="https://youtu.be" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
                ...
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400 flex items-center">
    <svg className="h-14 w-14" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" fill="none">
        <path d="M224.1 141c-63.6 0-115.1 51.5-115.1 115.1 0 63.6 51.5 115.1 115.1 115.1s115.1-51.5 115.1-115.1c0-63.6-51.5-115.1-115.1-115.1zm0 190.5c-41.6 0-75.4-33.8-75.4-75.4s33.8-75.4 75.4-75.4 75.4 33.8 75.4 75.4-33.8 75.4-75.4 75.4zm146.4-194.3c0 14.9-12.1 27-27 27s-27-12.1-27-27 12.1-27 27-27 27 12.1 27 27zm76.1 27.2c-.1-55.6-45.4-100.9-100.9-100.9H102.4C46.9 63.5 1.6 108.8 1.6 164.3v185.4c0 55.6 45.4 100.9 100.9 100.9h185.4c55.6 0 100.9-45.4 100.9-100.9V164.4zm-50.3 185.5c0 30.1-24.5 54.6-54.6 54.6H102.4c-30.1 0-54.6-24.5-54.6-54.6V164.4c0-30.1 24.5-54.6 54.6-54.6h185.4c30.1 0 54.6 24.5 54.6 54.6v185.5z" fill="currentColor"/>
    </svg>
    <span className="ml-3 text-xl font-bold">Instagram</span>
</a>




<a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400 flex items-center">
    <svg className="h-11" viewBox="0 0 34 34" xmlns="http://www.w3.org/2000/svg" fill="none">
